...
For shared UI strings (nav, footer, breadcrumbs), Rosey works identically for RTL and LTR locales. See [Split by Directory](/docs/split-by-directory/) for the full pattern.
