---
_schema: docs
permalink: /docs/ai-translation/
title: "AI-Powered Translation"
layout: layouts/page.html
eleventyNavigation:
  key: "AI-Powered Translation"
  order: 1
tags: "workflows"
SEO_options:
  title:
...
This can run in a postbuild hook, a CI step, or a standalone script. For non-AI external services (machine translation APIs, TMS platforms) and CI automation patterns, see [External Integrations](/docs/integrations/).
...
Agent skills for AI coding assistants are maintained in [CloudCannon/agent-skills](https://github.com/CloudCannon/agent-skills), not shipped with this package. These are structured markdown files that guide agents through common workflows:
