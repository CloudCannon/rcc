export default function generateDefaultConfigFile() {
  return `
    ...
    _inputs:
      ...
      markdown_keys:
        type: array
        comment: Define namespaces that nominate a translation as requiring a type markdown input. Each markdown key namespace can define which markdown options are enabled.
        options:
        ...
        values:
          - value:
            ...
            _inputs:
              id: 
                type: text
                comment: The value used for the namespace that nominates a Rosey tag as needing a markdown type input for it's translation.
              enabled_markdown_options:
                type: object
                options:
                  preview:
