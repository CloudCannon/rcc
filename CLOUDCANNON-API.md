...
> **Source**: This document was compiled from the `@cloudcannon/editable-regions` source code, the `@cloudcannon/javascript-api` type definitions, and real-world usage in the [rcc-v2](https://github.com/CloudCannon/rcc) project.
